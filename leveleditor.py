...
path = "C:\\Users\\Asus\\Desktop\\Code\\Python\\BrainExe"
os.chdir(path)
...
def draw_bg():
    ...
    for x in range(4):
        ...
        screen.blit(vessels, ((x * width)-scroll * 0.6,
                    screen_height - vessels.get_height() - 350))
        screen.blit(blood, ((x * width)-scroll * 0.7,
                    screen_height - blood.get_height() + 400))


def draw_grid():
    # vertical lines
    for c in range(max_cols + 1):
        pygame.draw.line(screen, black, (c * tile_size - scroll, 0),
                         (c * tile_size - scroll, screen_height))
    # horizontal
    for c in range(rows + 1):
        pygame.draw.line(screen, black, (0, c * tile_size),
